...
class AutogenChat():
    def __init__(self, chat_id=None, websocket=None):
        ...
        self.creator = autogen.AssistantAgent(
            ...
            system_message="""You are a helpful assistant, you have creative ideas and will ask user for input and then provide solutions, you will not TERMINATE chat"""
        )
        self.critic = autogen.AssistantAgent(
            name="critic",
            llm_config=llm_config_assistant,
            max_consecutive_auto_reply=5,
            system_message="""You are a helpful assistant, you should validade the ideas from the creator and suggest improvements, you will not TERMINATE chat"""
        )
